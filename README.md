...
Versão atual: **1.0.9** (tile 48 + DPR até 3; alcance de coleta corrigido). (aparece no rodapé da tela).
...
- Os arquivos usam `?v=1.0.9` para o navegador não ficar com versão antiga após uma atualização
