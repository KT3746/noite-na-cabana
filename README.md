...
Versão atual: **1.1.0** (tile 48 + DPR até 3; alcance de coleta corrigido). (aparece no rodapé da tela).
...
- Os arquivos usam `?v=1.1.0` para o navegador não ficar com versão antiga após uma atualização
